...
type SimpleBankClient interface {
	...
	Transfer(ctx context.Context, in *TransferRequest, opts ...grpc.CallOption) (*BaseResponse, error)
}
...
func (c *simpleBankClient) Transfer(ctx context.Context, in *TransferRequest, opts ...grpc.CallOption) (*BaseResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(BaseResponse)
...
type SimpleBankServer interface {
	...
	Transfer(context.Context, *TransferRequest) (*BaseResponse, error)
...
func (UnimplementedSimpleBankServer) Transfer(context.Context, *TransferRequest) (*BaseResponse, error) {
